...
<source media="(min-width: 768px) and (max-width: 1279px) and (prefers-color-scheme: dark)" srcset="./public/DarkTablet.png">
<source media="(min-width: 768px) and (max-width: 1279px)" srcset="./public/Tablet.png">
<source media="(max-width: 767px) and (prefers-color-scheme: dark)" srcset="./public/DarkMobile.png">
