...
<picture>
<source media="(min-width: 1280px) and (prefers-color-scheme: white)" srcset="./public/Desktop.png">
<source media="(min-width: 1280px) and (prefers-color-scheme: dark)" srcset="./public/DarkDesktop.png">
<source media="(min-width: 768px) and (prefers-color-scheme: white)" srcset="./public/Tablet.png">
<source media="(min-width: 768px) and (prefers-color-scheme: dark)" srcset="./public/DarkTablet.png">
<source media="(prefers-color-scheme: white)" srcset="./public/Mobile.png">
<img alt="Chat Playground" src="./public/DarkMobile.png">
</picture>
